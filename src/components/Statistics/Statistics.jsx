...
const Statistics = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      const card = root.current.querySelector('[data-stats-card]');
  ...
  return (
    <div ref={root} className="pt-4 pr-0 pb-3 pl-2 lg:pl-4 h-full">
      <div data-stats-card className="bg-blue-500 bg-opacity-20 backdrop-blur-md h-[89vh] lg:h-full w-[78.5vw] lg:w-auto rounded-md flex flex-col justify-start items-start p-4 lg:p-10">
